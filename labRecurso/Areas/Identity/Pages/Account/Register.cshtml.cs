...
namespace labRecurso.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "{0} tem de ser pelo menos {2} e no máximo {1}", MinimumLength = 6)]
